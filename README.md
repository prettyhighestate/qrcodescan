...
The app runs on **Expo Go** using **SDK 54** and has been tested on **Android** devices. (tested on Galaxy A35 5G)
...
1. **Clone the repository**  
   ```bash
   git clone https://github.com/prettyhighestate/qrcodescan.git
   cd qrcodescan
...
The app supports both Light and Dark themes. Below are screenshots of the main screens in both modes.

### Scanner Screen – Light
![Scanner Light](screenshots/scannerlight.jpg)

### Scanner Screen – Dark
![Scanner Dark](screenshots/scannerdark.jpg)

### QR Generator – Light
![Generator Light](screenshots/qrgeneratorlight.jpg)

### QR Generator – Dark
![Generator Dark](screenshots/qrgeneratordark.jpg)

### History – Light
![History Light](screenshots/lighthistory.jpg)

### History – Dark
![History Dark](screenshots/darkhistory.jpg)

### Settings – Light
![Settings Light](screenshots/lightsettings.jpg)

### Settings – Dark
![Settings Dark](screenshots/darksettings.jpg)
---

## 5. Package dependencies Used
...
Throughout this project, I built a practical QR scanner app with mainly focussing on user experience. I added a clear scan overlay, a confirmation popup with copy, and a full history system.Furthemore using React Context made sharing state across screens simple, while AsyncStorage provided easy local persistence. I also handled camera permissions and added dark mode. Additionally I chose bottom tabs instead of a drawer for better Expo Go compatibility and easier navigation. Overall, the app meets the core requirements and shows my understanding of mobile development fundamentals.
